...
// Cuztom
add_action( 'init', 'godspeed_meta');
function godspeed_meta() {
...
function godspeed_support() {
  ...
  load_theme_textdomain( 'stormbringer', get_template_directory() . '/lang' );
	...
	godspeed_register_menus();            // WP menus
...
// Sidebars
function godspeed_register_sidebars() {
...
add_action('widgets_init', 'godspeed_register_sidebars' );

// Menus
function godspeed_register_menus() {
	register_nav_menus(
		array(
