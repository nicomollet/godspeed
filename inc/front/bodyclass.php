...
add_filter('body_class', 'godspeed_body_class');

/**
 * Body Class - Thanks to Theme Hyprid (http://themehybrid.com/)
 */
function godspeed_body_class( $classes = '' ) {
    global $wp_query;
    global $current_user;
    ...
    $classes = array_merge( $classes, godspeed_get_context() );
