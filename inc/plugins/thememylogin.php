...
function godspeed_thememylogin_options(){
...
function godspeed_thememylogin_enqueue_scripts() {
  wp_deregister_script('password-strength');
  wp_dequeue_style('password-strength');
}

add_action('wp_enqueue_scripts', 'godspeed_thememylogin_enqueue_scripts',60);

function godspeed_thememylogin_init() {
...
add_action( 'init', 'godspeed_thememylogin_init' );
...
/*
function godspeed_thememylogin_the_title( $title, $post_id = 0 ) {
  global $theme_my_login;
...
add_filter( 'the_title', 'godspeed_thememylogin_the_title', 10, 2 );
*/

/*
function godspeed_thememylogin_setup_nav_menu_item( $menu_item ) {
  global $theme_my_login;

  $args = godspeed_thememylogin_options();
...
add_filter( 'wp_setup_nav_menu_item', 'godspeed_thememylogin_setup_nav_menu_item' );
*/

function godspeed_thememylogin_errors($errors){
...
function godspeed_thememylogin_title( $title, $action ) {
...
add_filter( 'tml_title', 'godspeed_thememylogin_title', 11, 2 );
...
function godspeed_tml_template( $useTemplate, $templates ) {
...
add_filter( 'tml_template', 'godspeed_tml_template', 10, 3 );
