...
add_filter( 'wpseo_breadcrumb_output_wrapper', 'godspeed_wpseo_breadcrumb_output_wrapper_filter' );
function godspeed_wpseo_breadcrumb_output_wrapper_filter() {
	return 'p';
}

// Change breadcrumb wrapper class to ‘wrap’
add_filter( 'wpseo_breadcrumb_output_class', 'godspeed_wpseo_bc_output_class_filter' );
function godspeed_wpseo_bc_output_class_filter() {
	return 'breadcrumb';
}
